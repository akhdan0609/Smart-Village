...
export type PageRoute = 
  ...
  | 'admin-cover-beranda'
  | 'admin-cover-profil'
  | 'admin-cover-profil-tentang'
  | 'admin-cover-profil-sejarah'
  | 'admin-cover-profil-pemerintahan'
  | 'admin-cover-profil-anggaran'
  | 'admin-cover-potensi'
  | 'admin-cover-potensi-akomodasi'
  | 'admin-cover-potensi-umkm'
  | 'admin-cover-potensi-budaya'
  | 'admin-cover-potensi-budidaya'
  | 'admin-cover-pelayanan'
  | 'admin-cover-humas'
  | 'admin-cover-humas-press'
  | 'admin-cover-humas-galeri'
  | 'admin-cover-darurat'
  | 'staff-portal';
