...
export const Footer: React.FC<FooterProps> = ({ onNavigate, onOpenLoginModal, activePage, isAdminPage }) => {
  ...
  if (isAdmin) {
    return (
      <footer className="bg-[#053727] text-slate-200 border-t border-[#094734]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-400 text-center sm:text-left">
          <p>© 2026 Desa Warung Menteng. All rights reserved.</p>
          <span className="text-emerald-100/90 opacity-80 text-xs font-medium">
            Dikembangkan Oleh KKN Wigata Dharma v1.0.0
          </span>
