...
import { ShieldCheck, UserCog, Lock, Bell, Palette, Database, Download, Upload, Trash2, AlertTriangle, Save } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-base font-extrabold text-slate-900">Tampilan & Branding</h3>
            </div>
            <div className="space-y-3 pt-2 border-t border-slate-100">
              <button className="w-full flex items-center gap-3 px-4 py-3 bg-slate-50 hover:bg-slate-100 rounded-xl text-left transition">
                <Palette className="w-5 h-5 text-slate-500" />
                <span className="text-xs font-semibold text-slate-700">Tema Warna & Logo Desa</span>
              </button>
              <button className="w-full flex items-center gap-3 px-4 py-3 bg-slate-50 hover:bg-slate-100 rounded-xl text-left transition">
                <Palette className="w-5 h-5 text-slate-500" />
                <span className="text-xs font-semibold text-slate-700">Konfigurasi Hero Banner</span>
              </button>
              <button className="w-full flex items-center gap-3 px-4 py-3 bg-slate-50 hover:bg-slate-100 rounded-xl text-left transition">
                <Palette className="w-5 h-5 text-slate-500" />
                <span className="text-xs font-semibold text-slate-700">Custom CSS & JavaScript</span>
              </button>
            </div>
          </div>
