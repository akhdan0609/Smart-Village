...
const defaultPress: PengumumanItem[] = [
  { id: 'press-1', nomorSurat: '470/2024/DESA', judul: 'Pengumuman Libur Hari Raya Idul Fitri 1445 H', tanggal: '10 April 2024', berlakuHingga: '15 April 2024', kategori: 'Pengumuman Resmi', isi: 'Mengingatkan kepada seluruh warga Desa Warung Menteng bahwa kantor desa tutup pada tanggal 10-15 April 2024.', lampiran: '', penanggungJawab: 'Sekretaris Desa' },
  { id: 'press-2', nomorSurat: '471/2024/DESA', judul: 'Penutupan Jalan Sementara Dusun Ciburial', tanggal: '5 Mei 2024', berlakuHingga: '20 Mei 2024', kategori: 'Kebijakan Desa', isi: 'Sehubungan dengan pembangunan talud, jalan raya Dusun Ciburial akan ditutup sementara.', lampiran: '', penanggungJawab: 'Kaur Pemerintahan' },
];
