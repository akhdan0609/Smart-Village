        ...
        <div className="relative rounded-3xl overflow-hidden shadow-sm min-h-[260px] sm:min-h-[290px] flex items-center bg-slate-900">
          ...
          <div className="absolute inset-0 z-0">
            <img 
              ...
              alt="Budaya dan Adat Istiadat Desa Warung Menteng" 
          ...
          <div className="bg-white rounded-2xl max-w-xl w-full overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-150 my-8">
            <div className="relative h-60 w-full bg-slate-100">
              ...
              <div className="absolute bottom-3 left-3 bg-[#0b3b29]/90 text-white text-xs font-semibold px-3 py-1 rounded-full flex items-center gap-1.5">
                ...
                <span>Kearifan Budaya & Tradisi</span>
              </div>
            </div>
            ...
            <div className="p-6 space-y-4 max-h-[60vh] overflow-y-auto">
              <div>
                ...
                {activeItem.pelaku && (
                  <p className="text-xs text-slate-500 mt-1 flex items-center gap-1.5">
                    ...
                    <span>Pelaku Seni / Adat: <strong className="text-slate-800">{activeItem.pelaku}</strong></span>
                  </p>
                )}
              </div>
              ...
              {activeItem.waktuPelaksanaan && (
                <div className="p-3 bg-amber-50/70 rounded-xl border border-amber-200/80 flex items-center gap-2.5 text-xs text-amber-900">
                  <Calendar className="w-4 h-4 text-amber-700 shrink-0" />
                  <div>
                    <span className="text-[10px] text-amber-700 font-medium block">Waktu Pelaksanaan / Gelaran:</span>
                    <span className="font-semibold">{activeItem.waktuPelaksanaan}</span>
                  </div>
                </div>
              )}
